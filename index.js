...
function addGamesToPage(games) {
  ...
  for (const game of games) {
    ...
    let currGameCard = document.createElement("div");
    // add the class game-card to the list
    currGameCard.classList.add("game-card");
...
const displayStr = `A total of $${amountRaised.toLocaleString()} has been raised for ${totalGames} games. Currently ${numUnfunded} ${
